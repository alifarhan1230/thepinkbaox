...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-Light-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('assets/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Thepinkbaox</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Sitampan</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2019-2020 <a href="http://bkd.mataramkota.go.id">Badan Keuangan Daerah Kota Mataram</a>.</strong>
    All rights reserved.
